import os 
import sys
#sys.path.append("/home/cyd/myvllm")
...
def load_vllm():
    ...
    im_end_id = tokenizer.convert_tokens_to_ids("<|im_end_id|>")

    stop_words_ids=[im_start_id,  im_end_id, tokenizer.eos_token_id]
    # vLLM基础配置
...
async def chat(request: Request):
    ...
    results_iter = engine.generate(prompts, sampling_params=sampling_params,request_id=request_id)
